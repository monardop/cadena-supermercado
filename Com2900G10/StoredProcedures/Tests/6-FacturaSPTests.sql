...
EXEC [Com2900G10].[venta].[CrearFactura] '000-0-005',1,1234, 1, 'A','Consumidor Final','2024-11-09 09:00',1

/* Resultado esperado: Error - "El medio de pago de la factura no existe" */
EXEC [Com2900G10].[venta].[CrearFactura] '000-0-005', 999,1234,1,'A','Consumidor Final','2024-11-09 09:00',1
...
EXEC [Com2900G10].[venta].[CrearFactura] '000-0-005', 1,1234,1,'A','Consumidor Final','2024-11-09 09:00', 999

/* Resultado esperado: Error - "El cliente a facturar no existe" */
EXEC [Com2900G10].[venta].[CrearFactura] '000-0-005', 1,1234, 99, 'A','Consumidor Final','2024-11-09 09:00',1
...
EXEC [Com2900G10].[venta].[ModificarFactura] 1,'000-0-006', 1,1234,1,'B','Consumidor Final','2024-11-09 09:00',1,100

/* Resultado esperado: Error - "La factura no existe" */
EXEC [Com2900G10].[venta].[ModificarFactura] 999,'000-0-005', 1,1234,1,'B','Consumidor Final','2024-11-09 09:00',1,100

/* Resultado esperado: Error - "El medio de pago de la factura no existe" */
EXEC [Com2900G10].[venta].[ModificarFactura] 1,'000-0-005', 999,1234,1,'B','Consumidor Final','2024-11-09 09:00',1,100

/* Resultado esperado: Error - "El cliente a facturar no existe." */
EXEC [Com2900G10].[venta].[ModificarFactura] 2,'000-0-005', 1,1234,99,'B','Consumidor Final','2024-11-09 09:00',1,100